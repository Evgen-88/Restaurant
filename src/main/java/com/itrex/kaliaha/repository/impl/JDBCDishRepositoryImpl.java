...
public class JDBCDishRepositoryImpl
    ...
    public static final String DISH_DESCRIPTION_COLUMN = "dish_description";
    ...
    protected Dish construct(ResultSet resultSet) throws SQLException {
        return new Dish(
                ...
                DishGroup.valueOf(resultSet.getString(DISH_GROUP_COLUMN)),
                resultSet.getString(DISH_DESCRIPTION_COLUMN),
    ...
    protected void fillPreparedStatement(PreparedStatement preparedStatement, Dish dish) throws SQLException {
        ...
        preparedStatement.setString(3, dish.getDishGroup().toString());
